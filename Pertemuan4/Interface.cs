...
namespace Pertemuan4
{
    class Interface
    {
        ...
        string[] nama = {"arfan","ruzannah","hamas","afra","upa"};
        ...
        public void MainMenu()
        {
            ...
            Console.WriteLine("\t\t Sistem Pengolahan Gaji Pegawai PT Maju Jaya");
            ...
            switch (pilihan)
                ...
                default:
                    Console.WriteLine(GARIS); Console.WriteLine("Error: masukkan pilihan 1-4");
                    MainMenu();
                    break;
            ...
            Console.Clear();
            Console.WriteLine(GARIS);
            Console.WriteLine("Error: invalidinput"); 
            MainMenu();
        ...
        public void SalaryMenu(){
            ...
            foreach (string element in pegawai.getPegawai()){
                ...
                if (Convert.ToString(status[n - 1]) == "tetap"){ Console.WriteLine("| {0} \t| {1} \t| {2} \t| {3}\t|", n,element,status[n - 1],gajiTetap[n - 1]); }else{
            ...
            Console.WriteLine("Belum ada data absensi yang masuk"); Console.WriteLine();
       ...
       public void LoginMenu(){
        ...
        public void About(){
            ...
            Console.WriteLine("\t Sistem ini merupakan sistem penggajian karyawan milik PT Maju Jaya", GARIS);

            Console.WriteLine("\t\t\t Dibuat oleh Univ Gunadarma");

            Console.WriteLine("\t\t\t\t Tahun 2014");
